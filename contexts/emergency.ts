 ...
 * Information about emergency care, urgent situations, and immediate response protocols
 */
...
- Severe chest pain radiating to arm, jaw, or back
...
- **S**peech difficulty (slurred speech, inability to speak)
- **T**ime to call emergency (every minute counts)

**Other neurological emergencies:**
- Sudden severe headache ("worst headache of life")
- Sudden loss of consciousness
- Seizures (especially if first time or prolonged)
...
- Choking
- Turning blue (lips, face, fingernails)
- Severe asthma attack not responding to inhaler
- Suspected foreign object in airway
...
- High fever (>40°C/104°F) with altered mental status

## RIMAC Emergency Response System

### How It Works
1. **Call Emergency Hotline:** Available 24/7 all plans
2. **Immediate Triage:** Trained medical personnel assess urgency
3. **Response Activation:** 
   - Ambulance dispatch if needed
   - Direct emergency room admission arranged
   - Hospital notification and bed reservation
4. **Real-time Coordination:** Communication with emergency services
...
**Coverage:**
- All plans include emergency ambulance
- Ground ambulance (standard)
- Air ambulance (in remote areas if medically necessary)
- Medical transport between facilities
...
**Response Times:**
- Urban areas: 10-15 minutes average
- Suburban areas: 15-25 minutes average
- Rural areas: May vary, air transport if needed

## Emergency Room Coverage

### Network Emergency Facilities
RIMAC has agreements with major hospitals:
- Hospital Nacional Rebagliati
- Hospital Guillermo Almenara
- Clínica Ricardo Palma - Emergency
- Clínica San Felipe - Emergency
- Clínica Internacional - Emergency
- And 30+ emergency departments nationwide

### Services Covered
- Emergency room evaluation
- Emergency physician consultation
- Diagnostic tests (labs, X-rays, CT scans)
...
### Coverage by Plan
**All Plans (Premium, Plus, Basic):**
- Emergency care covered 100%
- No prior authorization required
- Copay waived for true emergencies
- Coverage at any facility (network or out-of-network) for emergencies

### What to Bring to Emergency Room
- RIMAC insurance card
...
### Chest Pain Protocol
1. Call emergency immediately if:
...
3. Chew aspirin if advised by emergency operator
4. Stay calm and rest
5. Monitor symptoms until help arrives
...
5. Don't give anything by mouth if breathing is difficult

### Severe Bleeding
**Action:**
1. Call emergency if bleeding is severe
2. Apply direct pressure with clean cloth
3. Maintain pressure (don't lift to check)
4. Elevate injured area above heart if possible
5. Apply additional cloths if blood soaks through
6. Don't remove embedded objects
7. Monitor for shock (pale, rapid pulse, weak)

### Stroke Response
**Act F.A.S.T:**
1. Recognize symptoms immediately
2. Call emergency - time is critical
3. Note time symptoms started
4. Keep person calm and lying down
5. Don't give food, drink, or medication
6. Monitor breathing and consciousness

### Seizure Response
**Action:**
1. Protect from injury (clear area, cushion head)
2. Turn on side if possible (prevents choking)
3. Time the seizure
4. Don't restrain or put anything in mouth
...
- Large area affected (size of palm or larger)
- Deep burns (white or charred appearance)
- Burns on face, hands, feet, genitals, or major joints
- Chemical or electrical burns
- Difficulty breathing after fire/smoke exposure

**Action:**
1. Remove from source
2. Cool with water (not ice) for 10-20 minutes
3. Cover with clean, dry cloth
4. Don't apply ointments or ice
...
**Action:**
1. Call emergency or suicide hotline immediately
2. Don't leave person alone
3. Remove access to weapons or medications
...
2. Call emergency services or police
3. Don't confront or argue
4. Create distance
5. Speak calmly if communication is necessary
6. Emergency psychiatric evaluation may be needed

## Post-Emergency Care

### Hospital Admission
If admitted after emergency:
...
- Home care arranged if needed
- Medical equipment coordinated
- Rehabilitation services if required

### Emergency Claim Process
1. Emergency care provided (no prior authorization needed)
2. Hospital bills RIMAC directly
3. Claim processed within 48-72 hours
4. Member notified of any copay or deductible
5. Follow-up care coordinated
...
### When to Use Emergency vs. Urgent Care
...
- Vomiting or diarrhea without severe symptoms
...
**Plus Plan:**
- Emergency coverage in South America
...
1. Call RIMAC international emergency line
2. Seek immediate care at nearest facility
3. Keep all receipts and documentation
4. Follow up with RIMAC for reimbursement
5. Coordinate return travel if needed
...
- **SAMU (Emergency Medical Service):** 106
- **Fire Department:** 116
- **National Police:** 105
