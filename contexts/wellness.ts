 ...
 * Information about wellness programs, mental health services, and lifestyle support
 */

export const wellnessContext = `
# RIMAC Wellness & Mental Health Programs

## Wellness Index (Índice de Bienestar)

### What Is It?
A comprehensive health score (0-100) that combines multiple factors to assess your overall wellbeing.
...
- **70-100:** Excellent wellbeing - Keep up the great work!
- **50-69:** Good wellbeing - Small improvements can make a difference
- **0-49:** Needs improvement - Let's work together on your health
...
- Potential insurance benefits/discounts
...
### Session Coverage by Plan
- **Premium:** 24 sessions per year
- **Plus:** 12 sessions per year
- **Basic:** 6 sessions per year

### How to Access
1. Request appointment through app or hotline
2. Initial evaluation with mental health professional
3. Treatment plan development
4. Regular sessions scheduled
5. Progress monitoring and adjustments

### Crisis Support
- 24/7 crisis hotline available
- Immediate virtual consultations for emergencies
- Connection to emergency psychiatric services
...
- **Lightly Active:** 7,500 steps/day
...
- Share achievements with healthcare team
...
### When to Seek Help
- Difficulty falling or staying asleep (>3 weeks)
...
### Hydration
- **Goal:** 8 glasses (2 liters) water daily
- More needed with exercise or hot weather
...
- Available through appointments
- Personalized meal planning
- Education on healthy eating
- Support for dietary changes
...
- Completing annual checkup
- Maintaining healthy weight
- Regular exercise
- Preventive screenings
- Medication adherence
- Participating in wellness programs
- Health education completion

## Recommendations Based on Wellness Index

### High Wellness (70-100)
...
### Low Wellness (0-49)
- Schedule comprehensive health evaluation
